...
def main():
    ...
    ap.add_argument("--out-dir", type=Path, default=OUT_DIR_DEFAULT / "smoke")
    ap.add_argument(
        "--smoke",
        action="store_true",
