...
in the parameter-trajectory gauge, with a specificity matrix testing whether
...
attribution argument, but formulated in the parameter-trajectory crosscoder
gauge of this paper.
...
This repo ships no figure-rendering code; the thesis top-K curves and
specificity matrix are rendered in the thesis LaTeX tree from these metrics.
...
These are the reproducible metrics behind the thesis figures — regenerated by
