...
pass). The contrastive-task localization figure
(`fig:app-contrastive-task-localization`, SVA / numeric / IOI / relational facts at
step 1000) is a different experiment: `causal/contrastive_task_feature_rescue`.
The CSV-aggregation step that the appendix
